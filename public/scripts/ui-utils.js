...
function syncGeneratedNotifications() {
  ...
  if (data.backupStatus?.stale) add("backup-overdue", "Backup Overdue", "No successful backup has been recorded in the last 7 days.", "backup", data.backupStatus?.latest?.id || "backup");
