...
const clientContactDepartments = [["admin", "Administration Department"], ["purchasing", "Purchasing Department"], ["accounting", "Accounting Department"], ["laboratory", "Laboratory Department"]];
const deliveryStatusOptions = ["Pending", "Document Delivered", "Copy Received w/ Proof of Receipt from Customer"];
