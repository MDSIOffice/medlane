...
## Corpus Check
- 46 files · ~278,890 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1955 nodes · 4216 edges · 112 communities (96 shown, 16 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 233 edges (avg confidence: 0.61)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `473eb38f`
...
Cohesion: 0.06
Nodes (50): buildPurchaseOrder(), buildSale(), collectInvoiceEditorLines(), collectInvoicePreviewLines(), cvYear(), discountNeedsApproval(), documentExists(), financialLineTemplate() (+42 more)
...
### Community 10 - "fetch"
Cohesion: 0.07
Nodes (57): activeMetadataUsage(), appStateKey(), auditLogDigestRows(), authenticatedProfile(), authenticatedUser(), backupStatus(), checkBackupFreshnessHealth(), cleanEmail() (+49 more)

### Community 11 - "renderAll"
Cohesion: 0.05
Nodes (53): applyRole(), approveExpense(), backupRunLabel(), canApproveMigrations(), canManageUsers(), confirmTransferDispatch(), confirmTransferReceive(), dedupedUsers() (+45 more)
...
Cohesion: 0.06
Nodes (52): canAccessKey(), canWrite(), checkSupabaseAppRecordsHealth(), daysUntilIso(), dedupeRowsByRecordKey(), defaultSeedSignature, DIGEST_AUDIT_NOISE_ACTIONS, DIGEST_COLORS (+44 more)
...
Cohesion: 0.10
Nodes (36): backupDigestLines(), checkAssetPageHealth(), discordFieldValue(), editDiscordWebhookMessage(), healthCheckLine(), inventoryPoTotal(), loadDigestSnapshot(), manilaMonthParts() (+28 more)
...
Cohesion: 0.14
Nodes (26): auditLogTableHtml(), brandedEmailHtml(), brandedInviteEmailHtml(), composeAndSendDigest(), digestAttentionBannerHtml(), digestDeltaBadge(), digestEmailHtml(), digestSectionHtml() (+18 more)
...
### Community 26 - "renderPrintTemplateSidePanel"
Cohesion: 0.15
...
### Community 39 - "buildSale"
Cohesion: 0.11
Nodes (21): buildInventoryPurchaseOrder(), buildPurchaseOrder(), buildSale(), discountNeedsApproval(), documentExists(), exportInvoicingCsv(), exportItemizedInvoicingCsv(), invoicingVisibleSales() (+13 more)
...
### Community 48 - "canApproveInventoryChanges"
Cohesion: 0.33
...
### Community 51 - "projectedRingPath"
Cohesion: 0.40
...
### Community 65 - "renderUserAuditLogTimeline"
Cohesion: 0.50
...
### Community 86 - "renderPlatformSettings"
Cohesion: 0.67
...
### Community 90 - "renderPurchaseHistory"
Cohesion: 0.67
...
- **Why does `MedlaneAPI` connect `saveStockSheet` to `fetch`?**
  _High betweenness centrality (0.276) - this node is a cross-community bridge._
- **Why does `MedlaneAPI` connect `saveStockSheet` to `fetch`?**
  _High betweenness centrality (0.263) - this node is a cross-community bridge._
- **Why does `backupStatus()` connect `fetch` to `saveStockSheet`, `worker.js`, `saveStockSheet`?**
