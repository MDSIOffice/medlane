...
## Corpus Check
- 60 files · ~320,607 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2226 nodes · 4732 edges · 122 communities (103 shown, 19 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 249 edges (avg confidence: 0.61)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e96bf7d0`
...
Cohesion: 0.05
Nodes (57): authHashParams(), clearBackupStatus(), confirmInviteUser(), downloadBackupFile(), downloadBackupObjectFile(), handleUserInvite(), hydrateAuthenticatedSession(), initializeRoute() (+49 more)
...
Cohesion: 0.03
Nodes (87): applyReconciliationHistory(), auditLogModules, bir2307DrawBoxedDigits(), bir2307DrawDigits(), bir2307DrawTin(), bir2307DrawTinLastGroup(), bir2307MMDDYYYY(), bir2307Money() (+79 more)
...
Cohesion: 0.07
Nodes (43): MedlaneAPI, acknowledgeMemo(), advancePurchaseOrderStatus(), applyRole(), approveExpense(), approvePurchaseOrder(), canApproveMigrations(), canApprovePurchaseOrders() (+35 more)

### Community 10 - "fetch"
Cohesion: 0.06
Nodes (53): applyReceivingLines(), authenticatedProfile(), authenticatedUser(), canAccessKey(), cleanEmail(), dedupeRowsByRecordKey(), enrichAuditLogEntry(), extractLinkResult() (+45 more)
...
Cohesion: 0.05
Nodes (55): auditContextForRequest(), browserName(), canWrite(), clientIp(), createAppSession(), daysUntilIso(), defaultSeedSignature, deviceName() (+47 more)
...
Cohesion: 0.09
Nodes (42): applyCollectionPayment(), approvePaymentRequest(), buildImportedClient(), buildImportedProduct(), buildImportedSupplier(), buildMigratedSale(), canApprovePaymentRequests(), cancelPaymentRequest() (+34 more)

### Community 16 - "syncStockSheetRow"
Cohesion: 0.10
Nodes (28): addStockSheetRow(), addTransferSheetRow(), branchOptions(), canApproveStockReceipts(), clearStockSheetDraft(), clearTransferSheetDraft(), fillStockSheetFromInventoryPo(), fillStockSheetFromReceipt() (+20 more)

### Community 17 - "recordSystemLog"
Cohesion: 0.12
Nodes (35): checkAssetPageHealth(), claimAutomationPeriod(), deleteDiscordWebhookMessage(), editDiscordWebhookMessage(), healthCheckLine(), loadDigestSnapshot(), manilaMonthParts(), manilaPeriodKeys() (+27 more)
...
Cohesion: 0.17
Nodes (16): canApproveDemoManagement(), canApproveDemoSales(), canCloseDemoRequest(), demoRequestActions(), demoRequestLineSummary(), inventoryItemLabel(), renderInventory(), renderInventoryBranchTabs() (+8 more)
...
Cohesion: 0.13
Nodes (28): auditLogTableHtml(), brandedEmailHtml(), brandedInviteEmailHtml(), composeAndSendDigest(), digestAttentionBannerHtml(), digestDeltaBadge(), digestEmailHtml(), digestProgressStateKey() (+20 more)
...
Cohesion: 0.11
Nodes (19): changeReportPreviewTemplate(), clearPrintTarget(), closeReportPreview(), getReportDefinitions(), openCollectionHistoryModal(), openReportPreview(), previewInventoryPurchaseOrder(), previewProductIssue() (+11 more)
...
### Community 34 - "renderReconciliation"
Cohesion: 0.18
...
Cohesion: 0.04
Nodes (77): archiveMasterlistRecord(), buildInventoryPurchaseOrder(), buildPurchaseOrder(), buildSale(), collectInvoiceEditorLines(), collectInvoicePreviewLines(), competingPurchaseOrdersForItem(), cvYear() (+69 more)
...
Cohesion: 0.12
Nodes (23): backupRunLabel(), calendarState(), canManageUsers(), cycleTimeCard(), formatBytes(), formatSessionDate(), lineChart(), monthLabel() (+15 more)
...
### Community 44 - "renderUsers"
Cohesion: 0.16
Nodes (18): canPostMemo(), dedupedUsers(), memoAcknowledgedByCurrentUser(), memoAudienceCheckboxesHtml(), memoCardHtml(), memoRecipientCount(), memoVisibleToCurrentUser(), nextMemoNumber() (+10 more)
...
### Community 50 - "computeValueMetrics"
Cohesion: 0.27
Nodes (10): averageOf(), catalogItemFor(), computeValueMetrics(), daysBetween(), demoTurnaroundDays(), financialApprovalDays(), poApprovalDays(), printSystemValueReport() (+2 more)

### Community 51 - "supabaseFetch"
Cohesion: 0.13
Nodes (25): activeMetadataUsage(), appStateKey(), auditLogDigestRows(), backupStatus(), checkBackupFreshnessHealth(), checkSupabaseAppRecordsHealth(), createBackup(), digestRecipients() (+17 more)
...
Cohesion: 0.11
Nodes (24): addMonthsToDate(), clientInvoiceReportHtml(), clientInvoicesExportRows(), clientInvoicesFilteredSales(), dashboardReportHtml(), exportClientInvoicesCsv(), itemForecastMonthKeys(), itemForecastMonthLabels() (+16 more)
...
Cohesion: 0.05
Nodes (60): MedlaneAPI, acknowledgeMemo(), advancePurchaseOrderStatus(), applyRole(), approveExpense(), approveFinancialRequest(), approvePurchaseOrder(), approveStockReceipt() (+52 more)
...
- **Why does `MedlaneAPI` connect `renderAll` to `supabaseFetch`?**
  _High betweenness centrality (0.227) - this node is a cross-community bridge._
- **Why does `MedlaneAPI` connect `renderAll` to `renderAll`, `supabaseFetch`?**
  _High betweenness centrality (0.222) - this node is a cross-community bridge._
- **Why does `backupStatus()` connect `supabaseFetch` to `renderAll`, `fetch`, `worker.js`, `renderAll`?**
