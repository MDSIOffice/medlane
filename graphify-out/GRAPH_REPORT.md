...
Cohesion: 0.14
Nodes (18): applyCollectionPayment(), editPurchaseOrder(), getReportDefinitions(), openReportPreview(), paymentRequestHistory(), renderInvoiceFlowDetail(), renderPaymentRequestDetail(), renderReportPage() (+10 more)
