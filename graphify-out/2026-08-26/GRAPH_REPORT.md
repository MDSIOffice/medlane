...
## Corpus Check
- 45 files · ~285,660 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2005 nodes · 4353 edges · 106 communities (91 shown, 15 thin omitted)
...
Cohesion: 0.07
Nodes (38): applyRole(), approveExpense(), canApproveMigrations(), confirmTransferDispatch(), confirmTransferReceive(), getReportDefinitions(), handleWorkflowAction(), importRevertBlockers() (+30 more)
...
Cohesion: 0.06
Nodes (47): canWrite(), daysUntilIso(), defaultSeedSignature, DIGEST_AUDIT_NOISE_ACTIONS, DIGEST_COLORS, DIGEST_METRIC_CARDS, DIGEST_ROLE_RECIPIENTS, DIGEST_SECTION_EMOJI (+39 more)
...
Cohesion: 0.12
Nodes (33): checkAssetPageHealth(), claimAutomationPeriod(), editDiscordWebhookMessage(), healthCheckLine(), loadDigestSnapshot(), loadDigestState(), manilaMonthParts(), manilaPeriodKeys() (+25 more)
...
Cohesion: 0.09
Nodes (37): buildPurchaseOrder(), buildSale(), collectInvoiceEditorLines(), collectInvoicePreviewLines(), competingPurchaseOrdersForItem(), discountNeedsApproval(), documentExists(), findClientByName() (+29 more)
...
Cohesion: 0.17
Nodes (20): activeMetadataUsage(), appStateKey(), auditLogDigestRows(), backupStatus(), checkBackupFreshnessHealth(), checkSupabaseAppRecordsHealth(), createBackup(), emailsForRoles() (+12 more)
...
### Community 55 - "supabaseAuthAdminFetch"
Cohesion: 0.31
...
- **Why does `backupStatus()` connect `supabaseFetch` to `worker.js`, `fetch`, `MedlaneAPI`, `saveStockSheet`?**
