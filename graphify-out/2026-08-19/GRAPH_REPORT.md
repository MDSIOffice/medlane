...
### Community 10 - "fetch"
Cohesion: 0.06
Nodes (47): authenticatedUser(), canAccessKey(), cleanEmail(), dedupeRowsByRecordKey(), enrichAuditLogEntry(), extractLinkResult(), fetch(), filterRecordsForProfile() (+39 more)
...
Cohesion: 0.06
Nodes (50): backupDigestLines(), canWrite(), daysUntilIso(), defaultSeedSignature, DIGEST_AUDIT_NOISE_ACTIONS, DIGEST_COLORS, DIGEST_METRIC_CARDS, DIGEST_ROLE_RECIPIENTS (+42 more)
...
Cohesion: 0.09
Nodes (33): buildInventoryPurchaseOrder(), buildPurchaseOrder(), buildSale(), collectFinancialLines(), collectPaymentRequestInvoices(), collectPaymentRequestLines(), discountNeedsApproval(), documentExists() (+25 more)
