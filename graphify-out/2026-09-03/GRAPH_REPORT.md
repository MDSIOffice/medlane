...
## Corpus Check
- 60 files · ~322,021 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2234 nodes · 4763 edges · 128 communities (107 shown, 21 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 249 edges (avg confidence: 0.61)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `13b4a321`
...
Cohesion: 0.07
Nodes (42): authHashParams(), clearBackupStatus(), confirmInviteUser(), downloadBackupFile(), downloadBackupObjectFile(), handleUserInvite(), hydrateAuthenticatedSession(), initializeRoute() (+34 more)
...
Cohesion: 0.02
Nodes (99): addDemoRequestLine(), applyReconciliationHistory(), auditLogModules, bir2307DrawBoxedDigits(), bir2307DrawDigits(), bir2307DrawTin(), bir2307DrawTinLastGroup(), bir2307MMDDYYYY() (+91 more)
...
### Community 10 - "fetch"
Cohesion: 0.06
Nodes (52): applyReceivingLines(), authenticatedProfile(), authenticatedUser(), canAccessKey(), cleanEmail(), dedupeRowsByRecordKey(), enrichAuditLogEntry(), extractLinkResult() (+44 more)
...
Cohesion: 0.05
Nodes (61): addDays(), auditContextForRequest(), browserName(), canWrite(), clientIp(), createAppSession(), daysUntilIso(), defaultSeedSignature (+53 more)
...
Cohesion: 0.12
Nodes (35): checkAssetPageHealth(), claimAutomationPeriod(), deleteDiscordWebhookMessage(), editDiscordWebhookMessage(), gameBadgeForScore(), gameLevelForXp(), healthCheckLine(), loadDigestSnapshot() (+27 more)
...
Cohesion: 0.10
Nodes (41): applyScoreResult(), attemptScoreSubmit(), closeGameModal(), computeThemeColors(), doJump(), drawGame(), drawRoundedRect(), endGame() (+33 more)
...
### Community 29 - "computeValueMetrics"
Cohesion: 0.15
...
Cohesion: 0.22
Nodes (10): changeReportPreviewTemplate(), clearPrintTarget(), closeReportPreview(), previewFinancialRequest(), previewInventoryPurchaseOrder(), previewProductIssue(), printInvoice(), printReportPreview() (+2 more)

### Community 31 - "openModal"
Cohesion: 0.07
Nodes (42): collectFinancialLines(), collectPaymentRequestInvoices(), collectPaymentRequestLines(), cvYear(), financialLineTemplate(), financialRequestDeductions(), findClientByName(), nextCvNumber() (+34 more)
...
### Community 34 - "confirmDetailsModal"
Cohesion: 0.18
Nodes (14): approveFinancialRequest(), buildPrintTemplateCanvas(), cancelFinancialRequest(), confirmDetailsModal(), confirmFinancialPayment(), confirmPaymentDetailsModal(), financialRequestDetailFields(), printTemplateRecord() (+6 more)
...
Cohesion: 0.13
Nodes (20): addMonthsToDate(), changeReportPreviewTemplate(), clearPrintTarget(), closeReportPreview(), fitPrintTemplateRows(), itemForecastMonthKeys(), itemForecastMonthLabels(), itemForecastRows() (+12 more)
...
Cohesion: 0.11
Nodes (21): clientInvoiceReportHtml(), clientInvoicesExportRows(), clientInvoicesFilteredSales(), dashboardReportHtml(), demoRequestHistoryCard(), exportClientInvoicesCsv(), itemForecastReportHtml(), memoAudienceLabel() (+13 more)
...
### Community 90 - "renderReconciliation"
Cohesion: 0.20
...
Cohesion: 0.06
Nodes (46): applyRole(), approveExpense(), archiveMasterlistRecord(), canApproveMigrations(), confirmTransferDispatch(), confirmTransferReceive(), editPurchaseOrder(), getReportDefinitions() (+38 more)
...
Cohesion: 0.11
Nodes (27): backupDigestLines(), buildBusinessSummaryLines(), composeAndSendDigest(), computeBusinessMetrics(), dashboardAnalyticsFields(), detectThresholdsAndApprovals(), digestClientBalance(), digestDaysUntil() (+19 more)
...
### Community 123 - "syncBackendUsers"
Cohesion: 0.40
...
## Knowledge Gaps
- **253 isolated node(s):** `common.sh script`, `peso`, `today`, `uomOptions`, `supplierClassificationOptions` (+248 more)
...
- **Why does `backupStatus()` connect `supabaseFetch` to `saveStockSheet`, `worker.js`, `fetch`, `renderInventory`?**
